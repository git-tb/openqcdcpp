...
extern double chL_g_2_etalist[73];
extern double chL_g_2_chilist[49];
...
/// Transversal part
double chTg_2_0(double eta, double chi);

/// 2 part
double ch2g_2_0(double eta, double chi);
...
/// extern double chL_g_2_etalist[73]; /// use the same grid as above
/// extern double chL_g_2_chilist[49]; /// use the same grid as above
extern bool chL_g_2_1_interper_initialized;
extern _2D::BicubicInterpolator<double> chL_g_2_1_interper;

/// Transversal part
double chTg_2_1(double eta, double chi);

/// 2 part
double ch2g_2_1(double eta, double chi);
