...
double F2(double x, double Q2, FLAG flags = 0);
...
double F2integrand(double z, double Q2, double x, FLAG flags = 0);

/// @brief transformation of F2integrand that samples closer to small z
double F2integrand_logtrafo1(double t, double Q2, double x, FLAG flags = 0);

/// @brief transformation of F2integrand that samples closer to large z
double F2integrand_logtrafo2(double t, double Q2, double x, FLAG flags = 0);
