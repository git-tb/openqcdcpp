...
int main()	{
	...
	for(int iq2 = 0; iq2 < NQ2; iq2++)	{
		...
		std::cout	<< std::setw(WIDTH) << "x" 
					<< std::setw(WIDTH) << "z"
					<< std::setw(WIDTH) << "F2heavyintegrand@nlo"
					<< std::setw(WIDTH) << "F2heavyintegrand@nnlo"
					<< std::endl;
		for(int ix = 0; ix < NX; ix++)	{
			...
			for(int iz = 0; iz < NZ; iz++)	{
				...
				std::cout	<< std::setw(WIDTH) << x
							<< std::setw(WIDTH) << z
							<< std::setw(WIDTH) << F2heavyintegrand_nlo
							<< std::setw(WIDTH) << F2heavyintegrand_nnlo
							<< std::endl;
			}
			std::cout << std::endl;
		}
	...
	std::cout << Pdf::xf(G,0.5,10) << std::endl;
	std::cout << xqg(1,0.5,10,0) << std::endl;
}